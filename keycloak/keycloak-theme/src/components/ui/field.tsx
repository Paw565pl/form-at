 ...
 *
 * $ npx keycloakify own --path "components/ui/field.tsx" --revert
 */
  ...
  return (
    <Label
      ...
      className={cn(
        ...
        "has-[>[data-slot=field]]:w-full has-[>[data-slot=field]]:flex-col has-[>[data-slot=field]]:rounded-md has-[>[data-slot=field]]:border [&>*]:data-[slot=field]:p-4 px-3",
        "font-normal",
...
function FieldError({
  ...
  return (
    <div role="alert" data-slot="field-error" className={cn("text-destructive text-sm font-normal px-3", className)} {...props}>
      {content}
    </div>
  );
}
