...
export const FormBaseForm = ({
  ...
  const formDataDefaultValues: FormData = {
    ...
    language: defaultValues?.language ?? Language.En,
    status: defaultValues?.status ?? FormStatus.Public,
    shuffleVariant: defaultValues?.shuffleVariant ?? "NONE",
    password: "",
    thanksMessage: defaultValues?.thanksMessage ?? "",
    estimatedDuration:
      defaultValues?.estimatedDuration ?? FormEstimatedDuration.PT10M,
