package format.backend.newupload.api;

import format.backend.auth.IsAuthenticated;
import format.backend.auth.UserClaims;
import format.backend.newupload.application.uploadrequest.BatchUploadRequestDto;
import format.backend.newupload.application.uploadrequest.UploadRequestHandler;
